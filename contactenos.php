...
<head>
    ...
    <script src="guardarmensaje.php" ></script>
</head>
<body>
	<div id="header-container"><!-- contenedor de la cabecera -->
		<header class="wrapper clearfix"><!-- cabecera de página -->
			<br><div id="title"><h1>AG</h1><h2> construcción</h2></div>
			<nav><!-- comienza menú de navegación-->
				<ul>
			...
			</nav><!-- termina menú de navegación-->
		</header>
	</div>
	<div id="main-container"><!-- contenedor del contenido principal-->
		<div id="main" class="wrapper clearfix"><!-- contenido principal -->
			...
			<aside>
				...
				<p align="center">Alberto Gómez Gallardo<br>
                Celular: 98434233<br>
                Osorno</p>
			</aside>
	...
	<div id="footer-container">
		<footer class="wrapper">
			<h3>Alberto Gomez Construcción - dirección comercial - <a href="mailto:direccion de correo">nombre correo</a></h3>
		</footer>
	</div>

<!-- variables del Spoiler-->
